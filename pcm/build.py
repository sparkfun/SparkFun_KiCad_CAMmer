...
src_path = path.join(path.dirname(__file__),'..','SparkFunKiCadCAMmer')
...
md['versions'][0].update({
    'version': verstr,
    'download_url': 'https://github.com/sparkfun/SparkFun_KiCad_CAMmer/releases/download/v{0}/SparkFunKiCadCAMmer-{0}-pcm.zip'.format(verstr)
})
...
# Zip all files
zip_file = 'SparkFunKiCadCAMmer-{0}-pcm.zip'.format(md['versions'][0]['version'])
...
shutil.move('plugin', 'SparkFunKiCadCAMmer-{0}-pcm'.format(md['versions'][0]['version']))
